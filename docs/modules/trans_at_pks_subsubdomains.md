...
|RED_SHDB | The KSs of this clade are specific either  for beta-gamma-double bonds (canonical double bonds are located between the alpha and beta position),or reduced double bonds. KS domainss with substrate specificities for shifted double bonds usually group with KS domains that show substrate specificity for completely reduced moieties.  | [Helfrich et. al. 2019](#Helfrich2019)
