...
|RED_SHDB | The KSs of this clade are specific either  for beta-gamma-double bonds (canonical double bonds are located between the alpha and beta position),or reduced double bonds. KS domains with substrate specifities for shifted double bonds usually group with KS domain that show substrate specificity for completely reduced moeities.  | [Helfrich et. al. 2019](#Helfrich2019)
...
|NON_ELOGATING_PYR | The KS of this module is non-elongating and specific for pyran or furan rings, depending of the presence of an in-trans-acting hydroxylase two modules upstream.| [Helfrich et. al. 2019](#Helfrich2019)
